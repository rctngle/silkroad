		...
		<div class="case-outer">
			<div class="case">
				...
				<div class="case__row--full summary">
					<?php if(get_field('summary_ml_rich_text_basic') && strlen(xinjiang_translate_field(get_field('summary_ml_rich_text_basic'))) > 0):?>
						<p><?php echo xinjiang_translate_field(get_field('summary_ml_rich_text_basic')); ?></p>
					<?php endif;?>
				</div>
