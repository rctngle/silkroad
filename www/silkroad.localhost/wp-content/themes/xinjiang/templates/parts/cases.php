...
$cases_page = xinjiang_get_post_by_slug('page', 'missing-and-detained-people');
...
<div class="content-box section-title centered">
	...
	<h1><?php echo xinjiang_translate_field(get_field('title_ml_text', $cases_page->ID)); ?></h1>		
	...
	<?php if ($download_this_data_url): ?>
		<div class="cases-download-container">
			<a target="_blank" href="<?php echo $download_this_data_url; ?>">
				...
				<div class="label"><?php echo xinjiang_translate('download-this-data'); ?></div>
			</a>
		</div>
	<?php endif; ?>

	<div>
		<?php echo xinjiang_translate_field(get_field('content_ml_rich_text', $cases_page->ID)); ?>
	</div>
</div>
