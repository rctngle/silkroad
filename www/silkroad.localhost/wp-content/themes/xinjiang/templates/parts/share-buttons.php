...
<ul>
	<li>
		<a class="share-button ico-facebook" href="http://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($share_url); ?>&t=<?php echo urlencode($share_title); ?>" target="_blank">
			<img src="<?php bloginfo('template_directory');?>/assets/images/ico-facebook-white.svg">
			<span>Facebook</span>
		</a>
	</li>
	<li>
		<a class="share-button ico-twitter" href="http://www.twitter.com/intent/tweet?text=<?php echo urlencode($share_title); ?>" target="_blank">
